...
def AppUpdate():
    ...
    ProjCreateButton = Button(Hintv,bg='#4A4A4A',text='Update',font=('ariel',5),highlightthickness=0,borderwidth=0,fg='white',command= lambda: webbrowser.open('http://google.com'))
...
class Main():
    ...
    def Home(core):
        ...
        Title = Label(bar_top, text='Python Designer', fg='white', bg='#383838',font=("conthrax-sb", 15))
        Title.place(x=220,y=10)
        
        Version = Label(bar_top, text=core.Version, fg='white', bg='#383838',font=("conthrax-sb", 6))
        Version.place(x=800,y=54)
    ...
    def Exec():
        ...
        Main.Home(base)
        base.root.mainloop()
        Main.Base_Folders((r'Projects/',r'Projects/.Trash',r'User/'))
